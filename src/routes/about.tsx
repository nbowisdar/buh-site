			...
			<div className="min-h-screen bg-background">
				<div className="min-h-screen bg-background">
					<div className="max-w-6xl mx-auto px-4 py-20">
						<h1 className="text-5xl font-bold text-[rgb(0,162,224)] mb-8 text-balance">Про нас</h1>
						...
						<div className="grid md:grid-cols-2 gap-12 mb-16">
							<div>
								<h2 className="text-2xl font-semibold text-[rgb(0,162,224)] mb-4">Наша історія</h2>
							...
							<div className="bg-muted rounded-lg p-8">
								<h2 className="text-2xl font-semibold text-[rgb(0,162,224)] mb-6">Наші цінності</h2>
								<ul className="space-y-4 text-lg">
									<li className="flex items-start gap-3">
										<span className="text-[rgb(0,162,224)] font-bold mt-1">✓</span>
						...
						<div className="bg-[rgb(0,162,224)]/10 rounded-lg p-8 border border-[rgb(0,162,224)]/20">
							<h2 className="text-2xl font-semibold text-[rgb(0,162,224)] mb-6">Статистика</h2>
							<div className="grid md:grid-cols-3 gap-8">
								<div className="text-center">
									<div className="text-4xl font-bold text-[rgb(0,162,224)] mb-2">500+</div>
									<p className="text-foreground/70">Задоволених клієнтів</p>
								</div>
								<div className="text-center">
									<div className="text-4xl font-bold text-[rgb(0,162,224)] mb-2">15+</div>
									<p className="text-foreground/70">Років досвіду</p>
								</div>
								<div className="text-center">
									<div className="text-4xl font-bold text-[rgb(0,162,224)] mb-2">100%</div>
