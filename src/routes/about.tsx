		...
		<section>
			<div className="min-h-screen bg-background">
				<div className="max-w-6xl mx-auto px-4 py-20">
					<h1 className="text-5xl font-bold text-primary mb-8 text-balance">Про нас</h1>

					<div className="grid md:grid-cols-2 gap-12 mb-16">
						<div>
							<h2 className="text-2xl font-semibold text-primary mb-4">Наша історія</h2>
							...
							<p className="text-lg text-foreground/80 leading-relaxed">
								Ми гордимося своєю репутацією надійного партнера для сотень компаній по всій Україні. Наша мета — допомогти вашому
								бізнесу зростати й розвиватися, забезпечивши якісну фінансову аналітику та консультації.
							</p>
						</div>
						<div className="relative h-[300px] rounded-lg overflow-hidden shadow-lg">
							<Image
								src="/accounting-office-interior-with-team-collaboration.jpg"
								alt="Наш офіс"
								width={400}
								height={300}
					...
					<div className="bg-muted rounded-lg p-8 mb-16">
						<h2 className="text-2xl font-semibold text-primary mb-6">Наші цінності</h2>
					...
					<div className="bg-accent/10 rounded-lg p-8 border border-accent/20">
						<h2 className="text-2xl font-semibold text-primary mb-6">Статистика</h2>
